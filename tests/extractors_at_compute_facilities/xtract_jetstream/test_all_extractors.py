...
def register_functions(execution_information, fxc=None):
    extractors = execution_information['extractors']
    extractor_home = execution_information['extractor_home']
    ...
    for item in extractors:
        ...
        fn_uuid = fxc.register_function(base_extractor,  # extractors[item]['extractor'],
