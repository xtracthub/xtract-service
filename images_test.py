...
from extractors.xtract_imagesort import ImageExtractor
...
sys_path_add = "/Users/joaovictor/xtract-images"
...
base_path = "/Users/joaovictor/xtract-images/training_data/graphics"
test_fam_1.add_group(files=[{'path': os.path.join(base_path, 'social.png'), 'metadata': dict()}], parser=None)
